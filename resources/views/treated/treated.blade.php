...
<section class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Bệnh nhân hoàn thành điều trị</h3>
                        ...
                        @foreach ($patients as $patient)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form id="change-debit-{{$patient->id}}" action="{{ route('home-untreated', ['patient' => $patient->id]) }}" method="POST">
                                            @csrf
                                        </form>
                                        {{-- <form action="">
                                            <button type="submit" class="btn btn-secondary btn-sm">
                                                Chuyển trạng thái <br> Hoàn thành điều trị
                                            </button>
                                        </form> --}}
                                    </td>
                                    <td class="project-actions text-right">
                                        <form action="{{ route('show-treated', ['patient' => $patient->id ]) }}">
                                            @csrf
...
<script>
    ...
    function Changedebit(id) {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Bạn chắc chắn muốn chuyển đổi trạng thái này',
            type: 'warning',
