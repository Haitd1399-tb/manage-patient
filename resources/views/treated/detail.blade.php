            ...
            <div class="col-md-9">
                <div class="card">
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="tableDrug" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                                    <thead>
                                                        <tr>
                    ...
                    <div class="tab-pane" id="orientals">
                        ...
                        <div class="mt-3">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg-2">
                                Đơn thuốc
                            </button>

                            <div class="modal fade bd-example-modal-lg-2" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="tableDay" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                            <thead>
                                                <tr>
                ...
                <div class="advance">
                    ...
                    <div class="row mt-2 p-2 align-items-center">
                        <div class="col-md-3 text-center">
                            <span>Ngày điều trị:</span><strong> {{date('d-m-Y',strtotime($advance->validate_Advance))}}</strong>
                        </div>
                        <div class="col-md-3 text-center">
