...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'icon'        => 'nav-icon fas fa-solid fa-plus-circle',
                ],
                [
                    'text'        => 'Ghi nợ',
                    'url'         => 'admin/home-debit',
                    'icon'        => 'nav-icon fas fa-solid fa-exclamation-circle',
                ],
                [
                    'text'        => 'Hoàn thành',
                    'url'         => 'admin/home-treated',
                    'icon'        => 'nav-icon fas fa-solid fa-check-circle ',
                ],
            ],
        ],
        [
        ...
        [
            'text' => 'Kho thuốc đông y',
            'url'  => 'admin/storeOriental',
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/1.12.0/css/jquery.dataTables.min.css',
                ],
            ],
        ],
        'Select2' => [
